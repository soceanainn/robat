...
const discard = /^(@|https?:|\/\/)/;
const stopWords = new RegExp('^(i|me|my|myself|self|' +
    'mé|mo|mise|féin|' +
    'we|us|our|ours|ourselves|' +
    'muid|ár|muidne|sinn|' +
    'you|your|yours|yourself|yourselves|' +
    'tú|tusa|do|bhur|sibh|sibhse|' +
    'he|him|his|himself|' +
    'é|eisean|sé|a|seisean|' +
    ...
    'do|does|did|doing|' +
    'déan|rinne|déanfaidh|' +
    'will|would|should|can|could|ought|' +
    'a|an|the|and|but|if|or|because|as|until|while|of|at|by|for|with|' +
    'an|ach|má|ba|go|dtí|nó|ná|nuair|ar|ag|le|de|sa|roimh|' +
    'orm|ormsa|ort|ortsa|air|uirthi|orainn|orthu|oraibh|' +
    'agam|agamsa|agat|agatsa|aige|aici|againn|againne|acu|agaibh|agaibhse|' +
    'liom|liomsa|leat|leatsa|leis|léi|linn|linne|leo|libh|libhse|' +
    'ionam|ionamsa|ionat|ionatsa|ann|inti|ionainn|ionaibh|iontu|' +
    'romham|romhamsa|romhat|romhatsa|roimhe|roimpi|romhainn|rompu|romhaibh|' +
    'fúm|fúmsa|fút|fútsa|faoi|fúithi|fúinn|fúthu|fúibh|fúibhse|' +
    'uaim|uaimse|uait|uaitse|uaidh|uaithi|uainn|uathu|uaibh|uaibhse|' +
    'chugam|chugat|chugatsa|chuige|chuici|chugainn|chucu|chugaibhse|' +
    'about|against|between|into|through|during|before|after|above|below|to|from|' +
    'gcoinne|idir|eatarthu|eadrainn|isteach|istigh|amach|amuigh|ndiaidh|thar|faoi|ó|go|chuig|' +
    'up|upon|down|in|out|on|off|over|under|again|further|then|once|here|there|' +
